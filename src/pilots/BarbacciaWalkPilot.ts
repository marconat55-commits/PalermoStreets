...
const ROOT = '/art_source/stage1_zen/barbaccia_arcade_v1/walk_frames_v1/';
const FRAMES = [
  ['contact_right.png', 145],
  ['pass_right.png', 125],
  ['contact_left.png', 145],
  ['settle.png', 135],
  ['pass_left.png', 125],
  ['return_contact.png', 145],
] as const;
...
export class BarbacciaWalkPilot {
  ...
  private makeUi(): Container {
    ...
    const title = new Text({
      text: 'BARBACCIA ARCADE V1 - CAMMINATA 6 POSE',
