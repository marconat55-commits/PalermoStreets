...
- M01 strada/cortile: bordo posteriore variabile `605 → 570 → 605`, limite anteriore `705` (100–135 px);
- M02 cortile/porticato: `515–705` (190 px);
- M03 campetto: `475–705` (230 px);
- M04 ingresso: `510–705` (195 px, invariata).

M01 segue ora la prospettiva del cortile: resta davanti ai marciapiedi presso le facciate e recupera profondita soltanto nell'apertura centrale. M02–M04 mantengono il piano pavimentato necessario per aggiramenti, gruppi di nemici e futuri oggetti ambientali. Posizioni di ingresso, spawn e oggetti rimangono comprese nei limiti.
...
I test bloccano regressioni a corsie troppo sottili: M01 deve conservare 135 px nel cortile e il profilo prospettico completo; M02–M04 almeno 190 px. La validazione geometrica continua a controllare ingressi, spawn, world width, camera e limiti 0–720.
