...
- M01 strada/cortile: bordo posteriore `625 → 640`, con discesa prospettica graduale verso destra; limite anteriore `705` (65–80 px).
...
I test bloccano la calibrazione indicata in gioco: M01 conserva 65–80 px e una lieve pendenza prospettica; M02–M04 almeno 190 px. La validazione geometrica continua a controllare ingressi, spawn, world width, camera e limiti 0–720.
